...
%\cleardoublepage
%%Chapter 7
%\input{./Chapters/Thesis-MSc-Chapter_7.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
% -----------------------------------------------------------------------------
...
\appendix
%% First Appendix
%\pdfbookmark[0]{Appendix A}{appendix1}
...
%% Second Appendix
%\pdfbookmark[0]{Appendix B}{appendix2}
\input{./Chapters/Thesis-MSc-AppendixB.tex}
%% If Printing on DOUBLE SIDED pages, the second page should be white.
%% Otherwise, comment the following command:
\cleardoublepage

%\pdfbookmark[0]{Appendix C}{appendix3}
\input{./Chapters/Thesis-MSc-AppendixE.tex}
%% If Printing on DOUBLE SIDED pages, the second page should be white.
%% Otherwise, comment the following command:
\cleardoublepage
